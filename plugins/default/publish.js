const doop = require('./node_modules/jsdoc/util/doop');
const env = require('./node_modules/jsdoc/env');
const fs = require('./node_modules/jsdoc/fs');
const helper = require('./node_modules/jsdoc/util/templateHelper');
const logger = require('./node_modules/jsdoc/util/logger');
const path = require('./node_modules/jsdoc/path');
const taffy = require('taffydb').taffy;
const template = require('./node_modules/jsdoc/template');
...
exports.publish = (taffyData, opts, tutorials) => {
    ...
    if (conf.default.staticFiles) {
        ...
        staticFilePaths = conf.default.staticFiles.include ||
            ...
            [];
        staticFileFilter = new (require('./node_modules/jsdoc/src/filter').Filter)(conf.default.staticFiles);
        staticFileScanner = new (require('./node_modules/jsdoc/src/scanner').Scanner)();
